...
# the day of the week is then set to the variable name day_of_week for future reference
...
if day_of_week in weekdays: 
    print ('Yes, unfortunately today is a weekday') # if the value of day_of_week variable is present in the weekdays list the program prints this string for the user 
